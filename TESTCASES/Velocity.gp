...
f2 = 'SST_MediumBody_with.inlet.dat.profile.interpolated_GEP/postProcessing/sample/81000/'			# ON OFF
f3 = 'SST_MediumBody_with.inlet.dat.profile.interpolated_GEP_aij_OFF_Rij_ON/postProcessing/sample/78000/'	# OFF ON
f4 = 'SST_MediumBody_with.inlet.dat.profile.interpolated_GEP_all_ON/postProcessing/sample/83000/'		# ON ON
...
f23a = 'run_01427_BOW/BOR/postProcessing/sampleDict/2000/' # BOW
f23b = 'run_01983_CENTER/BOR/postProcessing/sampleDict/2000/' # CENTER
f23c = 'run_00611_STERN/BOR/postProcessing/sampleDict/2000/' # STERN
f23d = 'run_00178_WAKE/BOR/postProcessing/sampleDict/2000/' # WAKE
f23e = 'run_00595_WAKE_U_Rwall/BOR/postProcessing/sampleDict/2000/' # WAKE U+Rwall
...
f28a = 'running_pfac150_pop500_seed0_run_00653/BOR/postProcessing/sampleDict/2000/' # ALL
...
do for  [i=1:words(xR)] {   
	...
	plot \
	f10.head.word(xR,i).tail  		u 2:1 with l ls 104 title "OF7 GEP", \
	f11.head.word(xR,i).tail  		u 2:1 with l ls 105 title "OF8 GEP", \
	exp_head.word(exp_expr,i).exp_tail 	u 4:2 with l ls 100 title "Exp.", \
	cfd1_head.word(cfd1_expr,i).cfd1_tail	u 4:2 with l ls 112 title "CFD1", \
	cfd2_head.word(cfd2_expr,i).cfd2_tail	u 4:2 with l ls 113 title "CFD2"
}
...
#do for  [i=1:words(xR)] {   
#	set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
#	print f1a.head.word(xR,i).tail
#	print f1b.head.word(xR,i).tail
#	print exp_head.word(exp_expr,i).exp_tail	
#	print cfd1_head.word(cfd1_expr,i).cfd1_tail
#	print cfd1_head.word(cfd1_expr,i).cfd2_tail
#	plot \
#	f1a.head.word(xR,i).tail  		u 2:1 with l ls 101 title "Baseline", \
#	f1b.head.word(xR,i).tail  		u 2:1 with l ls 102 title "Baseline new", \
#	exp_head.word(exp_expr,i).exp_tail 	u 4:2 with l ls 100 title "Exp.", \
#	cfd1_head.word(cfd1_expr,i).cfd1_tail	u 4:2 with l ls 112 title "CFD1", \
#	cfd2_head.word(cfd2_expr,i).cfd2_tail	u 4:2 with l ls 113 title "CFD2"
#}
...
#	f9.head.word(xR,i).tail  		u 2:1 with l ls 102 title "Wallin", \
#	exp_head.word(exp_expr,i).exp_tail 	u 4:2 with l ls 100 title "Exp.", \
#	cfd1_head.word(cfd1_expr,i).cfd1_tail	u 4:2 with l ls 112 title "CFD1", \
#	cfd2_head.word(cfd2_expr,i).cfd2_tail	u 4:2 with l ls 113 title "CFD2"
#}
...
do for  [i=1:words(xR)] {   
	set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
	print f1b.head.word(xR,i).tail  		
	print f13.head.word(xR,i).tail  		
	print f14.head.word(xR,i).tail  		
	print f15.head.word(xR,i).tail  		
	print f16.head.word(xR,i).tail  		
	print exp_head.word(exp_expr,i).exp_tail	
	print cfd1_head.word(cfd1_expr,i).cfd1_tail
	print cfd1_head.word(cfd1_expr,i).cfd2_tail
	plot \
	f1b.head.word(xR,i).tail  		u ($2/1.0):1 with l ls 101 title "Baseline", \
	f13.head.word(xR,i).tail  		u ($2/2.2):1 with l ls 102 title "FlatePlate", \
	f14.head.word(xR,i).tail  		u ($2/2.2):1 with l ls 103 title "HumpFlow", \
	f15.head.word(xR,i).tail  		u ($2/2.2):1 with l ls 104 title "ChannelFlow", \
	f16.head.word(xR,i).tail  		u ($2/2.2):1 with l ls 105 title "JetFlow", \
	exp_head.word(exp_expr,i).exp_tail 	u 4:2 with l ls 100 title "Exp.", \
	cfd1_head.word(cfd1_expr,i).cfd1_tail	u 4:2 with l ls 112 title "CFD1", \
	cfd2_head.word(cfd2_expr,i).cfd2_tail	u 4:2 with l ls 113 title "CFD2"
}
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f17.head.word(xR,i).tail
        print f18.head.word(xR,i).tail
        print f19.head.word(xR,i).tail
        print f20.head.word(xR,i).tail
        print f21.head.word(xR,i).tail
        print f22.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        print cfd1_head.word(cfd1_expr,i).cfd1_tail
        print cfd1_head.word(cfd1_expr,i).cfd2_tail
        plot \
        f1b.head.word(xR,i).tail                u ($2/1.0):1 with l ls 101 title "Baseline", \
        f17.head.word(xR,i).tail                u ($2/2.2):1 with l ls 102 title "PH-EVE-MO-57 ON ON", \
        f18.head.word(xR,i).tail                u ($2/2.2):1 with l ls 103 title "PH-EVE-MO-57 ON OFF", \
        f19.head.word(xR,i).tail                u ($2/2.2):1 with l ls 104 title "PH-EVE-MO-57 OFF ON", \
        f20.head.word(xR,i).tail                u ($2/2.2):1 with l ls 105 title "PH-EVE-MO-11 ON ON", \
        f21.head.word(xR,i).tail                u ($2/2.2):1 with l ls 106 title "PH-EVE-MO-11 ON OFF", \
        f22.head.word(xR,i).tail                u ($2/2.2):1 with l ls 107 title "PH-EVE-MO-11 OFF ON", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
        cfd1_head.word(cfd1_expr,i).cfd1_tail   u 4:2 with l ls 112 title "CFD1", \
        cfd2_head.word(cfd2_expr,i).cfd2_tail   u 4:2 with l ls 113 title "CFD2"
}

plot 1/0 title "EMPTY FIGURE -- H1"
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        h1.head.word(xR,i).tail                 u 2:1 with l ls 102 title "run-00120 in the loop U+Rwall BOW NEW", \
        h2.head.word(xR,i).tail                 u 2:1 with l ls 103 title "run-00186 in the loop U+Rwall BOW ADDED FEATURES", \
        h3.head.word(xR,i).tail                 u 2:1 with l ls 104 title "run-00939 in the loop U+Rwall BOW ADDED FEATURES", \
        h4.head.word(xR,i).tail                 u 2:1 with l ls 105 title "run-00915 in the loop U+Rwall BOW ADDED FEATURES", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f23a.head.word(xR,i).tail
        print f23b.head.word(xR,i).tail
        print f23c.head.word(xR,i).tail
        print f23d.head.word(xR,i).tail
        print f23e.head.word(xR,i).tail
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        f23a.head.word(xR,i).tail               u 2:1 with l ls 102 title "run-01427 in the loop only U BOW", \
        f23b.head.word(xR,i).tail               u 2:1 with l ls 103 title "run-01983 in the loop only U CENTER", \
        f23c.head.word(xR,i).tail               u 2:1 with l ls 104 title "run-00611 in the loop only U STERN", \
        f23d.head.word(xR,i).tail               u 2:1 with l ls 105 title "run-00178 in the loop only U WAKE", \
        f23e.head.word(xR,i).tail               u 2:1 with l ls 106 title "run-00595 in the loop U+Rwall WAKE", \
        g1.head.word(xR,i).tail                 u 2:1 with l ls 107 title "run-00218 in the loop U+Rwall BOW NEW", \
        g2.head.word(xR,i).tail                 u 2:1 with l ls 108 title "run-00360 in the loop U+Rwall CENTER NEW", \
        g3.head.word(xR,i).tail                 u 2:1 with l ls 109 title "run-00611 in the loop U+Rwall STERN NEW", \
        g4.head.word(xR,i).tail                 u 2:1 with l ls 110 title "run-00178 in the loop U+Rwall WAKE NEW", \
        h1.head.word(xR,i).tail                 u 2:1 with l ls 111 title "run-00120 in the loop U+Rwall BOW NEW", \
        h2.head.word(xR,i).tail                 u 2:1 with l ls 112 title "run-00186 in the loop U+Rwall BOW ADDED FEATURES", \
        h3.head.word(xR,i).tail                 u 2:1 with l ls 113 title "run-00939 in the loop U+Rwall BOW ADDED FEATURES", \
        h4.head.word(xR,i).tail                 u 2:1 with l ls 114 title "run-00915 in the loop U+Rwall BOW ADDED FEATURES", \
        i1.head.word(xR,i).tail                 u 2:1 with l ls 114 title "run-00721 in the loop U+Rwall BOW ADDED FEATURES_Qs", \
        i2.head.word(xR,i).tail                 u 2:1 with l ls 115 title "run-00270 in the loop U+Rwall BOW ADDED FEATURES_Qs", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        i1.head.word(xR,i).tail                 u 2:1 with l ls 102 title "run-00721 in the loop U+Rwall BOW ADDED FEATURES_Qs", \
        i2.head.word(xR,i).tail                 u 2:1 with l ls 103 title "run-00270 in the loop U+Rwall BOW ADDED FEATURES_Qs", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}

plot 1/0 title "EMPTY FIGURE -- NEW GEP IN THE LOOP RESULTS"

do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        g1.head.word(xR,i).tail                 u 2:1 with l ls 102 title "run-00218 in the loop U+Rwall BOW NEW", \
        g2.head.word(xR,i).tail                 u 2:1 with l ls 103 title "run-00360 in the loop U+Rwall CENTER NEW", \
        g3.head.word(xR,i).tail                 u 2:1 with l ls 105 title "run-00611 in the loop U+Rwall STERN NEW", \
        g4.head.word(xR,i).tail                 u 2:1 with l ls 107 title "run-00178 in the loop U+Rwall WAKE NEW", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f28a.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        f28a.head.word(xR,i).tail               u 2:1 with l ls 102 title "U + Rwall all points", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}

plot 1/0 title "EMPTY FIGURE"

set ylabel 'r/R'     font ",25"
set xlabel 'U_x/U_b' font ",25"
...
#set xrange [0:1.2]        
set grid
set key samplen 3 spacing 1.15 font ",20"
set key at graph 0.01, 0.95
#set key at graph 0.6, 0.95
#set key font "20"
#set xtics font "25" 
#set ytics font "25" 
#set tics font "Times-Roman, 25"
set tics font "Verdana, 25"
#set x2tics 
#'14.9167' '15.4167' '15.9167' '16.4167'
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i) font ", 20"
	#set arrow from word(xR,i),0 to word(xR,i),0.1 nohead
	#set arrow from '14.916',graph(0,0) to '14.9167',graph(1,1) nohead
        print f1b.head.word(xR,i).tail
        print f23e.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        f23e.head.word(xR,i).tail               u 2:1 with l ls 103 title "CFD-driven GEP", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
	#f16.head.word(xR,i).tail  		u ($2/2.2):1 with l ls 102 title "JetFlow"
	#"/home/unimelb.edu.au/lcampoli/UoM/Testcases/BOR/DATA/BoR_Data/data_Oct_2021/turbStat/BoRDataCompilation_Medium_Wall.dat" u 1:2 axes x2y1 with l ls 116 title "BOR" 
}
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f24a.head.word(xR,i).tail
        print f24b.head.word(xR,i).tail
        print f24c.head.word(xR,i).tail
        print f24d.head.word(xR,i).tail
        print f24e.head.word(xR,i).tail
        print f24f.head.word(xR,i).tail
        print f24g.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        print cfd1_head.word(cfd1_expr,i).cfd1_tail
        print cfd1_head.word(cfd1_expr,i).cfd2_tail
        plot \
        f1b.head.word(xR,i).tail                u ($2/1.0):1 with l ls 101 title "Baseline", \
        f24a.head.word(xR,i).tail               u ($2/2.2):1 with l ls 102 title "squCyl Ha5 Rij 1", \
        f24b.head.word(xR,i).tail               u ($2/2.2):1 with l ls 103 title "squCyl Ha5 Rij 2", \
        f24c.head.word(xR,i).tail               u ($2/2.2):1 with l ls 104 title "squCyl Ha5 Rij 3", \
        f24d.head.word(xR,i).tail               u ($2/2.2):1 with l ls 105 title "squCyl Ha5 Rij 4", \
        f24e.head.word(xR,i).tail               u ($2/2.2):1 with l ls 106 title "squCyl Ha5 Rij 5", \
        f24f.head.word(xR,i).tail               u ($2/2.2):1 with l ls 107 title "squCyl Ha5 aij 2", \
        f24g.head.word(xR,i).tail               u ($2/2.2):1 with l ls 108 title "squCyl Ha5 aij 3", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
        cfd1_head.word(cfd1_expr,i).cfd1_tail   u 4:2 with l ls 112 title "CFD1", \
        cfd2_head.word(cfd2_expr,i).cfd2_tail   u 4:2 with l ls 113 title "CFD2"
}
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f26a.head.word(xR,i).tail
        print f26b.head.word(xR,i).tail
        print f26c.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        print cfd1_head.word(cfd1_expr,i).cfd1_tail
        print cfd1_head.word(cfd1_expr,i).cfd2_tail
        plot \
        f1b.head.word(xR,i).tail                u ($2/1.0):1 with l ls 101 title "Baseline", \
        f26a.head.word(xR,i).tail               u ($2/2.2):1 with l ls 102 title "cube aij OFF Rij ON", \
        f26b.head.word(xR,i).tail               u ($2/2.2):1 with l ls 103 title "cube aij ON Rij OFF", \
        f26c.head.word(xR,i).tail               u ($2/2.2):1 with l ls 104 title "cube aij ON Rij ON", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
        cfd1_head.word(cfd1_expr,i).cfd1_tail   u 4:2 with l ls 112 title "CFD1", \
        cfd2_head.word(cfd2_expr,i).cfd2_tail   u 4:2 with l ls 113 title "CFD2"
}
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f25a.head.word(xR,i).tail
        print f25b.head.word(xR,i).tail
        print f25d.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        print cfd1_head.word(cfd1_expr,i).cfd1_tail
        print cfd1_head.word(cfd1_expr,i).cfd2_tail
        plot \
        f1b.head.word(xR,i).tail                u ($2/1.0):1 with l ls 101 title "Baseline", \
        f25a.head.word(xR,i).tail               u ($2/2.2):1 with l ls 102 title "BFS OFF ON aij", \
        f25b.head.word(xR,i).tail               u ($2/2.2):1 with l ls 103 title "BFS ON OFF aij", \
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print f1b.head.word(xR,i).tail
        print f27.head.word(xR,i).tail
        print exp_head.word(exp_expr,i).exp_tail
        print cfd1_head.word(cfd1_expr,i).cfd1_tail
        print cfd1_head.word(cfd1_expr,i).cfd2_tail
        plot \
        f1b.head.word(xR,i).tail                u ($2/1.0):1 with l ls 101 title "Baseline", \
        f27.head.word(xR,i).tail                u ($2/2.2):1 with l ls 102 title "SNH2020-Reg-B", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
        cfd1_head.word(cfd1_expr,i).cfd1_tail   u 4:2 with l ls 112 title "CFD1", \
        cfd2_head.word(cfd2_expr,i).cfd2_tail   u 4:2 with l ls 113 title "CFD2"
}
...
#        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
#        print f1b.head.word(xR,i).tail
#        print f29.head.word(xR,i).tail
#        print exp_head.word(exp_expr,i).exp_tail
#        print cfd1_head.word(cfd1_expr,i).cfd1_tail
#        print cfd1_head.word(cfd1_expr,i).cfd2_tail
#        plot \
#        f1b.head.word(xR,i).tail                u ($2/1.0):1 with l ls 101 title "Baseline", \
#        f29.head.word(xR,i).tail                u ($2):1 with l ls 102 title "ML pipeline", \
#        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
#        cfd1_head.word(cfd1_expr,i).cfd1_tail   u 4:2 with l ls 112 title "CFD1", \
#        cfd2_head.word(cfd2_expr,i).cfd2_tail   u 4:2 with l ls 113 title "CFD2"
#}
...
do for  [i=1:words(xR)] {
	...
	#f5a.head.word(xR,i).tail  		u ($2):1     with l ls 107 title "GEP Chirtrav Lav", \
        #f24g.head.word(xR,i).tail               u ($2/2.2):1 with l ls 107 title "squCyl Ha5 aij 3", \
        #f22.head.word(xR,i).tail                u ($2/2.2):1 with l ls 104 title "PH-EVE-MO-11 OFF ON", \
...
do for  [i=1:words(xR)] {
	...
	f16.head.word(xR,i).tail  		u ($2/2.2):1 with l ls 102 title "JetFlow", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
        cfd1_head.word(cfd1_expr,i).cfd1_tail   u 4:2 with l ls 103 title "CFD"
}
        #f21.head.word(xR,i).tail                u ($2/2.2):1 with l ls 103 title "PH-EVE-MO-11 aij ON Rij OFF", \
        #f25d.head.word(xR,i).tail               u ($2/2.2):1 with l ls 104 title "BFS Rij", \
        #f26b.head.word(xR,i).tail               u ($2/2.2):1 with l ls 114 title "cube aij ON Rij OFF", \
	"/home/unimelb.edu.au/lcampoli/UoM/Testcases/BOR/DATA/BoR_Data/data_Oct_2021/turbStat/BoRDataCompilation_Medium_Wall.dat" u 1:2 axes x2y1 with l ls 116 notitle 
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        z1.head.word(xR,i).tail                 u 2:1 with l ls 102 title "run01052-1000-1000", \
        z3.head.word(xR,i).tail                 u 2:1 with l ls 104 title "run00771-1000-1000", \
        z5.head.word(xR,i).tail                 u 2:1 with l ls 106 title "run00276-1000-1000", \
        z6.head.word(xR,i).tail                 u 2:1 with l ls 107 title "run01003-1000-1000", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        w1.head.word(xR,i).tail                 u 2:1 with l ls 102 title "run00358-RUint", \
        w2.head.word(xR,i).tail                 u 2:1 with l ls 103 title "run00576-RUint", \
        w3.head.word(xR,i).tail                 u 2:1 with l ls 104 title "run00602-RUint", \
        w4.head.word(xR,i).tail                 u 2:1 with l ls 105 title "run00276-RUint", \
        w5.head.word(xR,i).tail                 u 2:1 with l ls 106 title "run00146-RUint", \
        w6.head.word(xR,i).tail                 u 2:1 with l ls 107 title "run00139-RUint", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        x1.head.word(xR,i).tail                 u 2:1 with l ls 102 title "run00358-URwallint", \
        x2.head.word(xR,i).tail                 u 2:1 with l ls 103 title "run00477-URwallintr", \
        x3.head.word(xR,i).tail                 u 2:1 with l ls 104 title "run00097-URwallintr", \
        x6.head.word(xR,i).tail                 u 2:1 with l ls 107 title "run00440-URwallintr", \
        x7.head.word(xR,i).tail                 u 2:1 with l ls 107 title "run00120-URwallintr", \
        zzz.head.word(xR,i).tail                u 2:1 with l ls 108 title "run00103-U1COST", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp.", \
}
        #x4.head.word(xR,i).tail                 u 2:1 with l ls 105 title "run00087-URwallintr", \
        #x5.head.word(xR,i).tail                 u 2:1 with l ls 106 title "run00403-URwallintr", \
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        pop50e.head.word(xR,i).tail             u 2:1 with l ls 102 title "pop50e", \
        pop50f.head.word(xR,i).tail             u 2:1 with l ls 103 title "pop50f", \
        pop50g.head.word(xR,i).tail             u 2:1 with l ls 105 title "pop50g", \
        pop50h.head.word(xR,i).tail             u 2:1 with l ls 107 title "pop50h", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp."
}
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        pop100a.head.word(xR,i).tail            u 2:1 with l ls 102 title "pop100a", \
        pop100b.head.word(xR,i).tail            u 2:1 with l ls 103 title "pop100b", \
        pop100c.head.word(xR,i).tail            u 2:1 with l ls 104 title "pop100c", \
        pop100d.head.word(xR,i).tail            u 2:1 with l ls 105 title "pop100d", \
        pop100e.head.word(xR,i).tail            u 2:1 with l ls 106 title "pop100e", \
        pop100f.head.word(xR,i).tail            u 2:1 with l ls 107 title "pop100f", \
        pop100g.head.word(xR,i).tail            u 2:1 with l ls 108 title "pop100g", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp."
}
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail                u 2:1 with l ls 101 title "Baseline", \
        pop200a.head.word(xR,i).tail            u 2:1 with l ls 102 title "pop200a", \
        pop200b.head.word(xR,i).tail            u 2:1 with l ls 103 title "pop200b", \
        pop200c.head.word(xR,i).tail            u 2:1 with l ls 104 title "pop200c", \
        pop200d.head.word(xR,i).tail            u 2:1 with l ls 105 title "pop200d", \
        pop200e.head.word(xR,i).tail            u 2:1 with l ls 106 title "pop200e", \
        pop200f.head.word(xR,i).tail            u 2:1 with l ls 107 title "pop200f", \
        pop200g.head.word(xR,i).tail            u 2:1 with l ls 108 title "pop200g", \
        exp_head.word(exp_expr,i).exp_tail      u 4:2 with l ls 100 title "Exp."
}
        #pop200h.head.word(xR,i).tail            u 2:1 with l ls 109 title "pop200h", \
        #pop200i.head.word(xR,i).tail            u 2:1 with l ls 110 title "pop200i", \
...
#        plot \
#        f1b.head.word(xR,i).tail              u 2:1 with l ls 101 title "Baseline", \
#        run01256C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01256-C4-pop100", \
#        run01842C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01842-C4-pop100", \ 
#        run01515C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01515-C4-pop100", \
#        run01335C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01335-C4-pop100", \
#        run01482C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01482-C4-pop100", \
#        run01053C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01053-C4-pop100", \
#        run01408C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01408-C4-pop100", \
#        run01477C4pop100.head.word(xR,i).tail u 2:1 with l ls 102 title "run_01477-C4-pop100", \
#	exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp."
#}
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print BOW1.head.word(xR,i).tail
        print BOW2.head.word(xR,i).tail
        print BOW3.head.word(xR,i).tail
        print BOW4.head.word(xR,i).tail
        print BOW5.head.word(xR,i).tail
        print BOW6.head.word(xR,i).tail
        print BOW7.head.word(xR,i).tail
        print BOW8.head.word(xR,i).tail
        print BOW9.head.word(xR,i).tail
        print BOW10.head.word(xR,i).tail
        print BOW11.head.word(xR,i).tail
        print BOW12.head.word(xR,i).tail
        print BOW13.head.word(xR,i).tail
        print BOW14.head.word(xR,i).tail
        print BOW15.head.word(xR,i).tail
        print BOW16.head.word(xR,i).tail
        print BOW17.head.word(xR,i).tail
        plot \
        f1b.head.word(xR,i).tail  u 2:1 with l ls 101 title "Baseline", \
        BOW1.head.word(xR,i).tail u 2:1 with l ls 102 title "bow1", \
        BOW2.head.word(xR,i).tail u 2:1 with l ls 103 title "bow2", \
        BOW3.head.word(xR,i).tail u 2:1 with l ls 104 title "bow3", \
        BOW4.head.word(xR,i).tail u 2:1 with l ls 105 title "bow4", \
        BOW6.head.word(xR,i).tail u 2:1 with l ls 107 title "bow6", \
        BOW7.head.word(xR,i).tail u 2:1 with l ls 108 title "bow7", \
        BOW8.head.word(xR,i).tail u 2:1 with l ls 109 title "bow8", \
        BOW9.head.word(xR,i).tail u 2:1 with l ls 110 title "bow9", \
        BOW10.head.word(xR,i).tail u 2:1 with l ls 111 title "bow10", \
        BOW11.head.word(xR,i).tail u 2:1 with l ls 113 title "bow11", \
        BOW13.head.word(xR,i).tail u 2:1 with l ls 115 title "bow13", \
        BOW14.head.word(xR,i).tail u 2:1 with l ls 116 title "bow14", \
        BOW17.head.word(xR,i).tail u 2:1 with l ls 119 title "bow17", \
        exp_head.word(exp_expr,i).exp_tail  u 4:2 with l ls 100 title "Exp."
}
        #BOW5.head.word(xR,i).tail u 2:1 with l ls 106 title "bow5", \
        #BOW12.head.word(xR,i).tail u 2:1 with l ls 114 title "bow12", \
        #BOW15.head.word(xR,i).tail u 2:1 with l ls 117 title "bow15", \
        #BOW16.head.word(xR,i).tail u 2:1 with l ls 118 title "bow16", \
...
do for  [i=1:words(xR)] {
        set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
        print WAKE1.head.word(xR,i).tail
        print WAKE2.head.word(xR,i).tail
        print WAKE3.head.word(xR,i).tail
        print WAKE4.head.word(xR,i).tail
        print WAKE5.head.word(xR,i).tail
        print WAKE6.head.word(xR,i).tail
        print WAKE7.head.word(xR,i).tail
        print WAKE8.head.word(xR,i).tail
        print WAKE9.head.word(xR,i).tail
        print WAKE10.head.word(xR,i).tail
        print WAKE11.head.word(xR,i).tail
        print WAKE12.head.word(xR,i).tail
        print WAKE13.head.word(xR,i).tail
        print WAKE14.head.word(xR,i).tail
        plot \
        f1b.head.word(xR,i).tail  u 2:1 with l ls 101 title "Baseline", \
        WAKE1.head.word(xR,i).tail u 2:1 with l ls 102 title "wake1", \
        WAKE2.head.word(xR,i).tail u 2:1 with l ls 103 title "wake2", \
        WAKE3.head.word(xR,i).tail u 2:1 with l ls 104 title "wake3", \
        WAKE4.head.word(xR,i).tail u 2:1 with l ls 105 title "wake4", \
        WAKE5.head.word(xR,i).tail u 2:1 with l ls 106 title "wake5", \
        WAKE6.head.word(xR,i).tail u 2:1 with l ls 107 title "wake6", \
        WAKE7.head.word(xR,i).tail u 2:1 with l ls 108 title "wake7", \
        WAKE8.head.word(xR,i).tail u 2:1 with l ls 109 title "wake8", \
        WAKE9.head.word(xR,i).tail u 2:1 with l ls 110 title "wake9", \
        WAKE10.head.word(xR,i).tail u 2:1 with l ls 111 title "wake10", \
        WAKE11.head.word(xR,i).tail u 2:1 with l ls 113 title "wake11", \
        WAKE12.head.word(xR,i).tail u 2:1 with l ls 114 title "wake12", \
        WAKE13.head.word(xR,i).tail u 2:1 with l ls 115 title "wake13", \
        WAKE14.head.word(xR,i).tail u 2:1 with l ls 116 title "wake14", \
        exp_head.word(exp_expr,i).exp_tail  u 4:2 with l ls 100 title "Exp."
}
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail  u 2:1 with l ls 101 title "Baseline", \
        CENTER5.head.word(xR,i).tail u 2:1 with l ls 106 title "center5", \
        CENTER8.head.word(xR,i).tail u 2:1 with l ls 109 title "center8", \
        CENTER10.head.word(xR,i).tail u 2:1 with l ls 111 title "center10", \
        CENTER13.head.word(xR,i).tail u 2:1 with l ls 115 title "center13", \
        exp_head.word(exp_expr,i).exp_tail  u 4:2 with l ls 100 title "Exp."
}
        #CENTER2.head.word(xR,i).tail u 2:1 with l ls 103 title "center2", \
        #CENTER1.head.word(xR,i).tail u 2:1 with l ls 102 title "center1", \
        #CENTER3.head.word(xR,i).tail u 2:1 with l ls 104 title "center3", \
        #CENTER6.head.word(xR,i).tail u 2:1 with l ls 107 title "center6", \
        #CENTER7.head.word(xR,i).tail u 2:1 with l ls 108 title "center7", \
        #CENTER4.head.word(xR,i).tail u 2:1 with l ls 105 title "center4", \
        #CENTER9.head.word(xR,i).tail u 2:1 with l ls 110 title "center9", \
        #CENTER11.head.word(xR,i).tail u 2:1 with l ls 113 title "center11", \
        #CENTER12.head.word(xR,i).tail u 2:1 with l ls 114 title "center12", \
        #CENTER15.head.word(xR,i).tail u 2:1 with l ls 117 title "center15", \
        #CENTER14.head.word(xR,i).tail u 2:1 with l ls 116 title "center14", \
        #CENTER16.head.word(xR,i).tail u 2:1 with l ls 118 title "center16", \
        #CENTER17.head.word(xR,i).tail u 2:1 with l ls 119 title "center17", \
...
do for  [i=1:words(xR)] {
        ...
        plot \
        f1b.head.word(xR,i).tail  u 2:1 with l ls 101 title "Baseline", \
        STERN8.head.word(xR,i).tail u 2:1 with l ls 109 title "stern8", \
        STERN11.head.word(xR,i).tail u 2:1 with l ls 113 title "stern11", \
        STERN16.head.word(xR,i).tail u 2:1 with l ls 118 title "stern16", \
        exp_head.word(exp_expr,i).exp_tail  u 4:2 with l ls 100 title "Exp."
}
        #STERN17.head.word(xR,i).tail u 2:1 with l ls 119 title "stern17", \
        #STERN12.head.word(xR,i).tail u 2:1 with l ls 114 title "stern12", \
        #STERN10.head.word(xR,i).tail u 2:1 with l ls 111 title "stern10", \
        #STERN7.head.word(xR,i).tail u 2:1 with l ls 108 title "stern7", \
        #STERN9.head.word(xR,i).tail u 2:1 with l ls 110 title "stern9", \
        #STERN1.head.word(xR,i).tail u 2:1 with l ls 102 title "stern1", \
        #STERN2.head.word(xR,i).tail u 2:1 with l ls 103 title "stern2", \
        #STERN3.head.word(xR,i).tail u 2:1 with l ls 104 title "stern3", \
        #STERN4.head.word(xR,i).tail u 2:1 with l ls 105 title "stern4", \
        #STERN5.head.word(xR,i).tail u 2:1 with l ls 105 title "stern5", \
        #STERN6.head.word(xR,i).tail u 2:1 with l ls 107 title "stern6", \
        #STERN13.head.word(xR,i).tail u 2:1 with l ls 115 title "stern13", \
        #STERN14.head.word(xR,i).tail u 2:1 with l ls 116 title "stern14", \
        #STERN15.head.word(xR,i).tail u 2:1 with l ls 117 title "stern15", \
