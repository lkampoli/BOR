...
do for  [i=1:words(xR)] {   
    ...
    plot \
    s_g0.head.word(xR,i).tail             u ($3*(4.1*4.1)/(0.186*0.186)):1 with l ls 101 title "g0", \
    s_g1.head.word(xR,i).tail             u ($3*(4.1*4.1)/(0.186*0.186)):1 with l ls 102 title "g1", \
    s_g2.head.word(xR,i).tail             u ($3*(4.1*4.1)/(0.186*0.186)):1 with l ls 103 title "g2", \
    s_g3.head.word(xR,i).tail             u ($3*(4.1*4.1)/(0.186*0.186)):1 with l ls 104 title "g3", \
    q_g0.head.word(xR,i).tail             u ($3*(4.1*4.1/(2.2*2.2))/(0.186*0.186)):1 ls 111 title "g0 IC", \
    q_g1.head.word(xR,i).tail             u ($3*(4.1*4.1/(2.2*2.2))/(0.186*0.186)):1 ls 112 title "g1 IC", \
    q_g2.head.word(xR,i).tail             u ($3*(4.1*4.1/(2.2*2.2))/(0.186*0.186)):1 ls 113 title "g2 IC", \
    q_g3.head.word(xR,i).tail             u ($3*(4.1*4.1/(2.2*2.2))/(0.186*0.186)):1 ls 114 title "g3 IC", \
    exp_head.word(exp_expr,i).exp_tail    u 8:2 with l ls 100 title "Exp.", \
    cfd2_head.word(cfd2_expr,i).cfd2_tail u 8:2 with l ls 115 title "CFD2"
}
...
do for  [i=1:words(xR)] {   
    set title 'Shear stresses for MEDIUM body at x/R='.word(xR, i)
    plot \
    s_g0.head.word(xR,i).tail             u ($3*(4.1*4.1)/(0.186*0.186)):1 with l    ls 101 title "BSL g0", \
    q_g0.head.word(xR,i).tail             u ($3*(4.1*4.1/(2.2*2.2))/(0.186*0.186)):1 ls 111 title "BSL g0 IC", \
    t_g0.head.word(xR,i).tail             u ($3*(4.1*4.1)/(0.186*0.186)):1           ls 102 title "BSL-g0-inlet02-p", \
    exp_head.word(exp_expr,i).exp_tail    u 8:2 with l                               ls 100 title "Exp.", \
    cfd2_head.word(cfd2_expr,i).cfd2_tail u 8:2 with l                               ls 115 title "CFD2"
}
