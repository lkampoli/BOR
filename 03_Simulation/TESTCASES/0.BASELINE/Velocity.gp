...
s_g0 ='BSL_g0/postProcessing/sampleDict/301000/'
s_g1 ='BSL_g1/postProcessing/sampleDict/29000/'
s_g2 ='BSL_g2/postProcessing/sampleDict/9000/'
s_g3 ='BSL_g3/postProcessing/sampleDict/37000/'

q_g0 ='BSL_g0_higher_IC/postProcessing/sampleDict/400000/'
q_g1 ='BSL_g1_higher_IC/postProcessing/sampleDict/50000/'
q_g2 ='BSL_g2_higher_IC/postProcessing/sampleDict/100000/'
q_g3 ='BSL_g3_higher_IC/postProcessing/sampleDict/110000/'

t_g0 ='BSL_g0_inlet02_p/postProcessing/sampleDict/400000/'

v0_g3 ='BSL_g3_higher_IC_nu_10-6/postProcessing/sampleDict/113000/'
v1_g3 ='BSL_g3_nu_10-6/postProcessing/sampleDict/42000/'
...
do for  [i=1:words(xR)] {   
   ...
   print s_g0.head.word(xR,i).tail
   print s_g1.head.word(xR,i).tail
   print s_g2.head.word(xR,i).tail
   print s_g3.head.word(xR,i).tail
   ...
   s_g0.head.word(xR,i).tail             u 2:1 with l ls 101 title "BSL-g0", \
   s_g1.head.word(xR,i).tail             u 2:1 with l ls 102 title "BSL-g1", \
   s_g2.head.word(xR,i).tail             u 2:1 with l ls 103 title "BSL-g2", \
   s_g3.head.word(xR,i).tail             u 2:1 with l ls 104 title "BSL-g3", \
   q_g0.head.word(xR,i).tail             u ($2/2.2):1 ls 111 title "BSL-g0-IC", \
   q_g1.head.word(xR,i).tail             u ($2/2.2):1 ls 112 title "BSL-g1-IC", \
   q_g2.head.word(xR,i).tail             u ($2/2.2):1 ls 113 title "BSL-g2-IC", \
   q_g3.head.word(xR,i).tail             u ($2/2.2):1 ls 114 title "BSL-g3-IC", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 106 title "CFD2"
}
...
do for  [i=1:words(xR)] {
   ...
   plot \
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   s_g1.head.word(xR,i).tail             u 2:1 with l ls 101 title "BSL-g1", \
   q_g1.head.word(xR,i).tail             u ($2/2.2):1 ls 111 title "BSL-g1-IC", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 106 title "CFD2"
}
do for  [i=1:words(xR)] {
   set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
   plot \
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   s_g2.head.word(xR,i).tail             u 2:1 with l ls 101 title "BSL-g2", \
   q_g3.head.word(xR,i).tail             u ($2/2.2):1 ls 111 title "BSL-g2-IC", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 106 title "CFD2"
}
do for  [i=1:words(xR)] {
   set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
   plot \
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   s_g3.head.word(xR,i).tail             u 2:1 with l ls 101 title "BSL-g3", \
   q_g3.head.word(xR,i).tail             u ($2/2.2):1 ls 111 title "BSL-g3-IC", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 106 title "CFD2"
}
...
do for  [i=1:words(xR)] {   
   ...
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   s_g0.head.word(xR,i).tail             u 2:1 with l ls 101 title "BSL-g0", \
   q_g0.head.word(xR,i).tail             u ($2/2.2):1 ls 102 title "BSL-g0-IC", \
   t_g0.head.word(xR,i).tail             u ($2):1     ls 103 title "BSL-g0-inlet02-p", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 106 title "CFD2"
}
...
do for  [i=1:words(xR)] {
   ...
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   s_g3.head.word(xR,i).tail             u 2:1 with l ls 101 title "BSL-g3", \
   q_g3.head.word(xR,i).tail             u ($2/2.2):1 ls 102 title "BSL-g3-IC", \
   v0_g3.head.word(xR,i).tail            u ($2/2.2):1 ls 103 title "BSL g3 higher IC nu 10-6", \
   v1_g3.head.word(xR,i).tail            u ($2):1     ls 104 title "BSL g3 nu_10-6", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 106 title "CFD2"
}
