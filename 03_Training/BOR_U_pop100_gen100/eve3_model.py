...
class Model(object):
    ...
    def train(self):
        ...
        if self.restart != 1:
            ...
            cost_fun1 = "sum(1.0/DATALEN/1.0*(BOR_U1-BOR_U0)**2)" # Mean axial velocity 
            #cost_fun1 = "sum(1.0/DATALEN/1.0*(BOW_U1-BOW_U0)**2)" # Mean axial velocity 
            #cost_fun1 = "sum(1.0/DATALEN/1.0*(U1-U0)**2)" # Mean axial velocity 
            #cost_fun2 = "sum(1.0/DATALEN/1.0*(R1-R0)**2)" # Reynolds wall shear stress
            ...
            if self.restart != 2:
                ...
                # Define symbols
                # Frozens
                U0sym = ea.EvalSymbol("BOR_U0", 0)

                # Actives
                U1sym = ea.EvalSymbol("BOR_U1", 0)
