...
if not sympy_err:
    ...
    x_positions = ['8.67','8.92','9.17','9.42','9.67','9.92','10.17','10.42','10.67','10.92','11.17','11.42','11.67','11.92','12.17']
    ...
    try:
        ...
        if (max_iter==0) | (max_iter==5000):
            ...
            for var in post_vars:
                ...
                save_file = 'STERN_' + var.upper() + 'xy1.edf.gz'
