...
g1  = 'BSL_g3_GEP_Chitrarth_Lav_higher_IC/postProcessing/sampleDict/60000/'
g2  = 'BSL_g3_GEP_Tr.aij.sqcyl.SNH2020-Reg-B_higher_IC/postProcessing/sampleDict/60000/'
g3  = 'BSL_g3_GEP_Tr.aijx_RijHat_PH_EVE-MO-11_aijx_ON_R_OFF_higher_IC/postProcessing/sampleDict/60000/'
g4  = 'BSL_g3_GEP_Tr.aijx.RijHat.squCyl.region_Ha5.newfrozenAppr.b.cube_aijx_OFF_R_ON_higher_IC/postProcessing/sampleDict/60000/'
g5  = 'BSL_g3_GEP_Tr.aijx.RijHat.squCyl.region_Ha5.newfrozenAppr.b.cube_aijx_ON_R_OFF_higher_IC/postProcessing/sampleDict/60000/'
g6  = 'BSL_g3_GEP_Tr.aijx.RijHat.squCyl.region_Ha5.newfrozenAppr.b.cube_aijx_ON_R_ON_higher_IC/postProcessing/sampleDict/60000/'
g7  = 'BSL_g3_GEP_Tr.aijx.RijHat.squCyl.region_Ha5.newfrozenAppr.f.cube_aijx_ON_R_OFF_higher_IC/postProcessing/sampleDict/60000/'
g8  = 'BSL_g3_GEP_Tr.aijx.squCyl.region_Ha5_newfrozenaijxRij_hat.3.eve_higher_IC/postProcessing/sampleDict/60000/'
g9  = 'BSL_g3_GEP_Tr.R.BFS.region.a5.k_froz_omega_froz_no-limiters_higher_IC/postProcessing/sampleDict/60000/'
...
do for  [i=1:words(xR)] {   
   ...
   f1.head.word(xR,i).tail               u 2:1 with l ls 101 title "f1",   \
   f2.head.word(xR,i).tail               u 2:1 with l ls 102 title "f2",   \
   f3.head.word(xR,i).tail               u 2:1 with l ls 103 title "f3",   \
   f4.head.word(xR,i).tail               u 2:1 with l ls 104 title "f4",   \
   f5.head.word(xR,i).tail               u 2:1 with l ls 105 title "f5",   \
   f6.head.word(xR,i).tail               u 2:1 with l ls 106 title "f6",   \
   f7.head.word(xR,i).tail               u 2:1 with l ls 107 title "f7",   \
   f8.head.word(xR,i).tail               u 2:1 with l ls 108 title "f8",   \
   f9.head.word(xR,i).tail               u 2:1 with l ls 109 title "f9",   \
   f10.head.word(xR,i).tail              u 2:1 with l ls 110 title "f10",  \
   ...
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 112 title "CFD2"
    ...
    plot 1/0 title "Comparison of BSL_g3_GEP_YuanFang_JetFlow and BSL_g0_GEP_YuanFang_JetFlow"
...
do for  [i=1:words(xR)] {   
   ...
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   f10.head.word(xR,i).tail              u 2:1 with l ls 110 title "f10",  \
   f11.head.word(xR,i).tail              u 2:1 with l ls 110 title "f11",  \
   cfd1_head.word(cfd1_expr,i).cfd1_tail u 4:2 with l ls 111 title "CFD1", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 112 title "CFD2"
}

    plot 1/0 title "Comparison of BSL_g3_GEP_YuanFang_JetFlow_OF7 and BSL_g3_GEP_YuanFang_JetFlow_OF7_higher_IC"

do for  [i=1:words(xR)] {   
   set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
   plot \
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   f14.head.word(xR,i).tail              u 2:1 with l ls 110 title "OF7",  \
   f15.head.word(xR,i).tail              u 2:1 with l ls 110 title "OF8",  \
   cfd1_head.word(cfd1_expr,i).cfd1_tail u 4:2 with l ls 111 title "CFD1", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 112 title "CFD2"
}

    plot 1/0 title "Comparison of BSL_g3_GEP_Chitrarth_Lav and BSL_g3_GEP_Chitrarth_Lav_higher_IC"

do for  [i=1:words(xR)] {   
   set title 'Axial mean velocity for MEDIUM body at x/R='.word(xR, i)
   plot \
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   f1.head.word(xR,i).tail               u 2:1 with l ls 101 title "Lav model",  \
   f1a.head.word(xR,i).tail              u ($2/2.2):1 ls 102 title "Lav model-IC",  \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 103 title "CFD2"
}

    plot 1/0 title "Comparison of all GEP frozen solutions with higher IC"
...
do for  [i=1:words(xR)] {   
   ...
   print g5.head.word(xR,i).tail
   print g6.head.word(xR,i).tail
   print g7.head.word(xR,i).tail
   print g8.head.word(xR,i).tail
   print g9.head.word(xR,i).tail
   print exp_head.word(exp_expr,i).exp_tail    
   print cfd1_head.word(cfd1_expr,i).cfd1_tail
   print cfd1_head.word(cfd1_expr,i).cfd2_tail
   plot \
   exp_head.word(exp_expr,i).exp_tail    u 4:2 with l ls 100 title "Exp.", \
   g1.head.word(xR,i).tail               u 2:1 with l ls 101 title "g1",   \
   g2.head.word(xR,i).tail               u 2:1 with l ls 102 title "g2",   \
   g3.head.word(xR,i).tail               u 2:1 with l ls 103 title "g3",   \
   g4.head.word(xR,i).tail               u 2:1 with l ls 104 title "g4",   \
   g5.head.word(xR,i).tail               u 2:1 with l ls 105 title "g5",   \
   g6.head.word(xR,i).tail               u 2:1 with l ls 106 title "g6",   \
   g7.head.word(xR,i).tail               u 2:1 with l ls 107 title "g7",   \
   g8.head.word(xR,i).tail               u 2:1 with l ls 108 title "g8",   \
   g9.head.word(xR,i).tail               u 2:1 with l ls 109 title "g9",   \
   cfd1_head.word(cfd1_expr,i).cfd1_tail u 4:2 with l ls 111 title "CFD1", \
   cfd2_head.word(cfd2_expr,i).cfd2_tail u 4:2 with l ls 112 title "CFD2"
}
